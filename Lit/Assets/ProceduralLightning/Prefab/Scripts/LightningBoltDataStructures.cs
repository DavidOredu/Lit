...
// Unity 4.X does not support glow or fade or elapsed time
    ...
    public class LightningThreadState
    {
        ...
        /// </summary>
        private readonly Queue<KeyValuePair<System.Action<bool>, ManualResetEvent>> actionsForMainThread = new Queue<KeyValuePair<System.Action<bool>, ManualResetEvent>>();
        ...
        {
            KeyValuePair<System.Action<bool>, ManualResetEvent> kv;
        ...
        public bool AddActionForMainThread(System.Action<bool> action, bool waitForAction = false)
        {
            ...
            lock (actionsForMainThread)
            {
                actionsForMainThread.Enqueue(new KeyValuePair<System.Action<bool>, ManualResetEvent>(action, evt));
            }
            if (evt != null)
            {
                evt.WaitOne(10000);
